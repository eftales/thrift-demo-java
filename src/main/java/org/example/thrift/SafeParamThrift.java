...
public class SafeParamThrift implements org.apache.thrift.TBase<SafeParamThrift, SafeParamThrift._Fields>, java.io.Serializable, Cloneable, Comparable<SafeParamThrift> {
  ...
  public int compareTo(SafeParamThrift other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCheckMethod()).compareTo(other.isSetCheckMethod());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCheckAlg()).compareTo(other.isSetCheckAlg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCheckAlg()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEncrypMethod()).compareTo(other.isSetEncrypMethod());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetEncrypAlg()).compareTo(other.isSetEncrypAlg());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEncrypAlg()) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRandNum()).compareTo(other.isSetRandNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRandNum()) {
